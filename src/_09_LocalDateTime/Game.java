...
public class Game {
    ...
    public void playGame() {
        ...
        for (int i = 0; i < tamanho; i++) {
            ...
            double tempoInicial = i > 0 ? golos[i - 1].getTempo() : 0;
            double randomTempo = ThreadLocalRandom.current().nextDouble(tempoInicial, 90 + 0.1);
            DecimalFormat df = new DecimalFormat("##.#");
            randomTempo = Double.parseDouble(df.format(randomTempo).replace(',', '.'));
    ...
    public String getDescription() {
        ...
        description.append(homeTeam.getNome())
                ...
                .append("Date:")
                .append(this.theDateTime.format(DateTimeFormatter.ISO_LOCAL_DATE))
                .append("\n");
